...
- Continue migrating any newly touched ROI decision logic into `probeflow.gui.roi_context`.
- Keep focused tests for line-required, area-required, empty-mask, and non-area fallback behavior.
