"""Feature Counting workspace widgets: image panel, sidebar, and workers.

Implementation module for the :mod:`probeflow.gui.features` package — see the
package ``__init__`` for the Browse/Viewer/Features boundary rules.  Import
the public names from the package, not from here.
"""
