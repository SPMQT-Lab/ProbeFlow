...
VALUE_LABELS: dict[str, str] = {
    ...
    "density_nm2": "Density (nm^-2)",
    "nn_median_nm": "NN median",
    "first_peak_nm": "First peak",
    "n_features": "N features",
    "n_matched": "Matched",
    "n_off_lattice": "Off-lattice",
    "n_duplicate_sites": "Duplicate sites",
    "rms_displacement_m": "RMS displacement",
    "mean_displacement_m": "Mean displacement",
    "occupancy": "Occupancy",
    "dx": "Δx",
    "dy": "Δy",
    "delta_x": "Δx",
