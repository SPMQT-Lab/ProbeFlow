...
VIEWER_COMMANDS: tuple[ViewerCommand, ...] = (
    ...
    ViewerCommand("fft.open", "FFT lattice correction...", "FFT", ("Ctrl+Shift+F",), "Fit reciprocal Bragg peaks to a known structure and preview undistortion.", aliases=("spectrum", "fourier")),
    ViewerCommand("fft.periodic_filter", "Periodic notch filter...", "FFT", ("Ctrl+Alt+F",), "Suppress selected FFT peaks; this is separate from lattice correction.", aliases=("notch", "lattice", "periodic")),
