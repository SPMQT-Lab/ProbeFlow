...
VIEWER_COMMANDS: tuple[ViewerCommand, ...] = (
    ...
    ViewerCommand("measure.pair_correlation", "Point statistics...", "Measurements", status_tip="Point-pattern statistics: g(r), nearest-neighbour distances, count, density.", aliases=("g(r)", "rdf", "radial distribution", "pair correlation", "nearest neighbour", "point statistics", "particle statistics")),
