...
VIEWER_COMMANDS: tuple[ViewerCommand, ...] = (
    ...
    ViewerCommand("view.dock_panels", "Dock panels into window", "View", status_tip="Re-dock the ROI Manager and Measurements panels back into the window if they are floating.", aliases=("float", "restore", "panels", "redock")),
